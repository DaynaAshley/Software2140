...
public class KJDatabase {
    ...
    public static void Connect(){
        ...
        try{
            ...
            String sql = "CREATE DATABASE IF NOT EXISTS KJTrucking";
            ...
            if (status==1){
                ...
                String sql11 = "CREATE TABLE WORK" +
                    "(driver_name VARCHAR(255), " +
                    " id INTEGER not NULL, "+
                    " company_name VARCHAR(255), " + 
                    " destination_name VARCHAR(255), " + 
                ...
                String sql9= "INSERT INTO PASSWORD VALUES ('1','Kemoy','Smith','12/1/1995','kemoy.smith@gmail.com','(876)234-1246','kemoy1life','124-754-754','XA3589')";
