...
public class Driver {
    ...
    public Driver(String name, int id, String address, String telephone, String email, String trn, String nis, String license, String bank_name,String branch,int acctnum){
        this.name=name;
    ...
    public static void AddDriver(Driver employee){
        ...
        try{
            ...
            String branch= employee.getBankBranch();
            int account=employee.getAccountNumber();
    ...
    public static Driver[] FindDriver(int id){
        ...
        try{
            ...
            while(rs.next()){
                ...
                int acct=rs.getInt(11);
                undriver=new Driver(uname,uid,uaddress,utelephone,uemail,utrn,unis,ulicense,bank,branch,acct);
    ...
    public static Driver[] UpdateDriver(int id,String name, String telephone, String address, String license, String email){
        ...
        try{
            ...
            while(rs1.next()){
                ...
                String bank=rs1.getString(9);
                String branch=rs1.getString(10);
                int acct=rs1.getInt(11);
                driver=new Driver(dname,did,daddress,dtelephone,demail,dtrn,dnis,dlicense,bank,branch,acct);
    ...
    public static void DriverWork(DriverWork driver1){
        ...
        try{
            ...
            Route[]r=RouteManager.FindRoute(driver1.getCompany(), driver1.getDestName());
            ps1.setString(1, driver1.getDriverName());
            ps1.setInt(2, driver1.getID());
            ps1.setString(3, driver1.getCompany());
            ps1.setString(4, driver1.getDestName());
            ps1.setDouble(5,r[0].getDriverWage());          
            ps1.executeUpdate();
        }catch(SQLException se){
            //Handle errors for JDBC
            se.printStackTrace();
    ...
    public static ArrayList<String> ReportFrequency(){
        ...
        try{
            ...
            while(result.next()){
                String least_driver=result.getString(1);
                String freq1=result.getString(2);
                frequent.add(least_driver);
                frequent.add(freq1);
            }

            String sql2= "SELECT SUM(weight) FROM DRIVERWORK";
            PreparedStatement ps2= conn.prepareStatement(sql2);

            ResultSet result1=ps2.executeQuery();
    
            while(result1.next()){
                double sum=result1.getDouble(1);
                frequent.add(String.valueOf(sum));
            }
