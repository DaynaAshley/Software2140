...
public class TextUI {
    ...
    public void AddUser(){
        ...
        User user1=new User(fname,lname,email,dob,telephone,id,password,trn,nis);
        User.AddUser(user1);
    ...
    public void ProfitReports() throws InterruptedException {
        int value=loginAdmin();
    ...
    public void WorkReport() throws InterruptedException {
        ...
        if (value==0){
            ...
            DriverWorkReport dr=new DriverWorkReport();
            dr.GenerateWorkReportTU();
...
private void UpdateTruckMenu() {
    ...
    Truck[] x = Truck.UpdateTruckInfo(Integer.parseInt(newTruckID), newTruckMake, newTruckmodel, newTruckLiscence, newtruckFitness, newTruckReg, newTruckIns);
